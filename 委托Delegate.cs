...
//模块，又即可避免“牵一发则动全身”的尴尬情况。“委托”这个命名就能很好说明了它的本质，即自己不做操作，只是告诉代理去哪做，以及做什么，但具体怎么做
//由代理操心。如，在餐厅中，厨师告诉采购员需要什么食材，在哪里可以搞到这些食材，以及到达目的地的所有可行方法，但实际上采用哪些方法去搞到食材，厨师
//并不关心。在有委托的结构中，Client就是采购员，决定调用哪些方法。
